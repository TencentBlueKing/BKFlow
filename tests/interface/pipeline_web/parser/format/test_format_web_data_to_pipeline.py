...
class MockSleepTimerService(Service):
    """Mock sleep_timer service"""
...
class MockSleepTimerComponent(Component):
    """Mock sleep_timer component for testing"""

    name = "sleep timer"
    code = "sleep_timer"
    bound_service = MockSleepTimerService
...
class FormatWebDataToPipelineTestCase(TestCase):
    @classmethod
    def setUpClass(cls):
        """注册 mock sleep_timer 组件"""
        ComponentLibrary.components["sleep_timer"] = {"legacy": MockSleepTimerComponent}

    @classmethod
    def tearDownClass(cls):
        """清理 mock 组件"""
        if "sleep_timer" in ComponentLibrary.components:
            ComponentLibrary.components.pop("sleep_timer")
    ...
    def test_normal(self):
        ...
        # 验证数据输入输出
        self.assertIn("inputs", result["data"])
