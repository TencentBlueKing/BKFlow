...
HTTP_REQUEST = "bkflow.pipeline_plugins.components.collections.http.v1_0.request"
HTTP_BOOLRULE = "bkflow.pipeline_plugins.components.collections.http.v1_0.BoolRule"
