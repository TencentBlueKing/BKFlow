...
- ✅ 前端协作补充：按最新 `prototype-wireframe` 规范补充节点使用 API 插件时的 V4.0.0 wiremd 线框、字段映射、全状态与交互标注
- ⏳ 依赖项：
...
- 前端原型覆盖 V4.0.0 节点 API 插件的正常配置、切换版本、历史失效版本回看三类状态，并明确 `plugin_version` 与 `wrapper_version/component.version` 的边界
