...
class BKPluginManagerViewSet(ReadOnlyViewSet, mixins.UpdateModelMixin):
    ...
    def list(self, request, *args, **kwargs):
        ...
        plugins = self.filter_plugins(plugins, query_serializer.validated_data)
                ...
                **(
                    {
                        ...
                        "status_update_time": localtime(authorization.status_update_time).isoformat(),
                    }
        ...
        if "status" in query_serializer.validated_data or "status_updator" in query_serializer.validated_data:
            result_data = self.filter_authorization(serializer.validated_data, query_serializer.validated_data)
    ...
    def filter_plugins(self, plugins, query_data):
    ...
    def filter_authorization(self, validated_data, query_data):
