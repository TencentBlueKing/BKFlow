...
from bkflow.pipeline_plugins.components.collections.remote_plugin.v1_0_0 import (
...
# mock path
PLUGIN_SERVICE_API_CLIENT = "bkflow.pipeline_plugins.components.collections.remote_plugin.v1_0_0.PluginServiceApiClient"
