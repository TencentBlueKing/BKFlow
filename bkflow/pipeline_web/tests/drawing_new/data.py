...
pipeline_with_circle = {
    ...
    "gateways": {
        "node4149a8d446a7fc325b66a7ee4350": {
            ...
            "conditions": {
                "line5371f9df4afe9bb4351abdc19239": {"evaluate": "1 == 1", "name": "1 == 1"},
                "line7ac5fc7341c9ccbf773e9ca0c9cf": {"evaluate": "1 == 0", "name": "1 == 0"},
            },
        }
    },
    "line": [
        {
            "id": "linede15c52c74c1f5f566450d2c975a",
            "source": {"arrow": "Right", "id": "node402bea676e660fab4cc643afafc8"},
            "target": {"arrow": "Left", "id": "nodeaf2161961809a91ebb00db88c814"},
        },
        {
            "source": {"id": "nodeaf2161961809a91ebb00db88c814", "arrow": "Right"},
            "target": {"id": "node4149a8d446a7fc325b66a7ee4350", "arrow": "Left"},
            "id": "line8602a85ef7e511765b77bc9f05e0",
        },
        {
            "source": {"id": "node4149a8d446a7fc325b66a7ee4350", "arrow": "Right"},
            "target": {"id": "nodeeb9b2a00e46adacd9f57720e8cca", "arrow": "Left"},
            "id": "line5371f9df4afe9bb4351abdc19239",
        },
        {
            "source": {"id": "nodeeb9b2a00e46adacd9f57720e8cca", "arrow": "Right"},
            "target": {"id": "nodea4bb3693dfb8d99d2084cee2fb8b", "arrow": "Left"},
            "id": "linecaddc6b1f1e421ce40456478dc6b",
        },
        {
            "source": {"id": "node4149a8d446a7fc325b66a7ee4350", "arrow": "Bottom"},
            "target": {"id": "node0dfa73e80b9bf40aa05f2442bb3d", "arrow": "Right"},
            "id": "line7ac5fc7341c9ccbf773e9ca0c9cf",
        },
        {
            "source": {"id": "node0dfa73e80b9bf40aa05f2442bb3d", "arrow": "Left"},
            "target": {"id": "nodeaf2161961809a91ebb00db88c814", "arrow": "Bottom"},
            "id": "line77a6cd587ff8476e75354c1d9469",
        },
    ],
    "location": [
        {"id": "node402bea676e660fab4cc643afafc8", "type": "startpoint", "x": 80, "y": 150},
        {
            "id": "nodeaf2161961809a91ebb00db88c814",
            "type": "tasknode",
            "name": "pause",
        ...
        {"id": "nodea4bb3693dfb8d99d2084cee2fb8b", "type": "endpoint", "x": 840, "y": 150},
        {"id": "node4149a8d446a7fc325b66a7ee4350", "type": "branchgateway", "name": "", "x": 465, "y": 155},
        {
            "id": "nodeeb9b2a00e46adacd9f57720e8cca",
            "type": "tasknode",
            "name": "pause",
...
pipeline_without_gateways = {
    "activities": {
        "node28b5acddd6ddd48c8d7728b48931": {
            ...
            "name": "node3",
            "error_ignorable": False,
            "component": {"code": "sleep_timer", "data": {"bk_timing": {"hook": True, "value": "${time3}"}}},
            "retryable": True,
            "skippable": True,
            "type": "ServiceActivity",
        ...
        "nodedd50630d1029bca78ad6efaf89d4": {
            ...
            "name": "node1",
            "error_ignorable": False,
            "component": {"code": "sleep_timer", "data": {"bk_timing": {"hook": True, "value": "${bk_timing}"}}},
            "retryable": True,
            "skippable": True,
            "type": "ServiceActivity",
        ...
        "nodeed4e2b6a13801df5c9a95cf9a233": {
            ...
            "name": "node2",
            "error_ignorable": False,
            "component": {"code": "sleep_timer", "data": {"bk_timing": {"hook": True, "value": "${time2}"}}},
            "retryable": True,
            "skippable": True,
            "type": "ServiceActivity",
    ...
    "constants": {
        "${bk_timing}": {
            ...
            "source_info": {"nodedd50630d1029bca78ad6efaf89d4": ["bk_timing"]},
            "name": "定时时间",
            "index": 0,
            "custom_type": "",
            "value": "3",
        ...
        "${time3}": {
            "source_tag": "sleep_timer.bk_timing",
            "source_info": {"node28b5acddd6ddd48c8d7728b48931": ["bk_timing"]},
            "name": "time3",
            "index": 2,
            "custom_type": "",
            "value": "",
        ...
        "${time2}": {
            "source_tag": "sleep_timer.bk_timing",
            "source_info": {"nodeed4e2b6a13801df5c9a95cf9a233": ["bk_timing"]},
            "name": "time2",
            "index": 1,
            "custom_type": "",
            "value": "2",
...
pipeline_with_gateways = pipeline_tree = {
    ...
    "gateways": {
        "nd97fecb12ed3c7a9047197e84c58549": {
            ...
            "outgoing": ["lf6d76d6272c3bce84caf3d1113992d7", "l74a1d2d3a4d30be8d53452f639616bd"],
            "type": "ParallelGateway",
            "id": "nd97fecb12ed3c7a9047197e84c58549",
            "name": "",
        },
        "nfc24efd8fd13301a800f1040d492a8e": {
            "incoming": ["l1471a752c513955af4b6a0779ab3b1d", "l774bb8683993b269005a0f13a38697a"],
        ...
        "nbb53904ad35364f97ccaa37328d92d9": {
            "incoming": ["la4c31c646483507a0af4704bfc9a05d", "lf477bb3adc43f71ad2c353e7da18b57"],
        ...
        "n0244a7271a235219364f1377d230d04": {
            "outgoing": ["l33b08b83afd31fba746853a54c49cc0", "ld7b5d7c371036019a55810d0d961986"],
            "incoming": "l12079c5e24a3b5eb22026a9a60a0638",
            "name": "",
            "type": "ExclusiveGateway",
            "conditions": {
                "l33b08b83afd31fba746853a54c49cc0": {"evaluate": "${bk_timing} > 10"},
                "ld7b5d7c371036019a55810d0d961986": {"evaluate": "${bk_timing} <= 10"},
            },
    ...
    "constants": {
        "${bk_timing}": {
            "source_tag": "sleep_timer.bk_timing",
            "source_info": {
                "n55c897bbc8c38cea18c99533348b1e3": ["bk_timing"],
                "n8ea7e6e5d76308cb3d9b151e2c4d82c": ["bk_timing"],
                "n9a17aecf7f232228e768152360564a3": ["bk_timing"],
            },
            "name": "timing",
            "index": 0,
            "custom_type": "",
