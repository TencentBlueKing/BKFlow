...
| key           | string   | Yes    | Variable key; must be unique within the space                   |
| variable_type | string   | Yes    | Variable type: space (space-level) or scope (scope-level) |
