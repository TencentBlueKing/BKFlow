...
Publish a workflow (SDK endpoint)
...
| is_deleted        | bool   | Whether the workflow is deleted   |
| triggers          | list   | Trigger information    |
| subprocess_info   | list   | Subprocess information    |
| auth              | list   | Workflow permissions     |
