...
Get plugin service application details (SDK endpoint)
...
| Field            | Type      | Description          |
|---------------|---------|-------------|
| url           | string  | Default URL in the current environment  |
| urls          | list    | All URLs in the current environment |
| name          | string  | Plugin name        |
| desc          | string  | Plugin description        |
| updated       | string  | Update time        |
| apigw_name    | string  | API gateway name    |
| tag_info      | dict    | Basic plugin information      |
