...
| color | string | No | Tag color, such as `#ffffff` |
| label_scope | list | No | Tag scopes (multiple allowed): `task`, `template`, `common`. A parent tag's updated scopes must cover those of all its children. |
