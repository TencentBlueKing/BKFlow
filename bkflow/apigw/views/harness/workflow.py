...
def validate_workflow(request, space_id):
    """确定性校验 a2flow 并生成不可变修订。"""
    return dispatch_harness_tool(request, space_id, ValidateWorkflowSerializer, "validate_workflow")
...
def create_workflow_draft(request, space_id):
    """基于已接受修订创建或更新模板草稿。"""
    return dispatch_harness_tool(request, space_id, CreateWorkflowDraftSerializer, "create_workflow_draft")
