...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["task_id", "node_id"], name="task_openpl_task_id_2eb8b8_idx"),
        ),
        migrations.AddIndex(
            model_name="openpluginruncallbackref",
            index=models.Index(fields=["callback_expire_at"], name="task_openpl_callbac_c6e036_idx"),
        ),
    ]
