  ...
  <div
    ...
    <div class="time-describe">
      <span
        ...
        @click="handleTimeTextChange('minute')">{{ $t('分') }}</span>
      <span
        class="time-text hour"
        @click="handleTimeTextChange('hour')">{{ $t('时') }}</span>
      <span
        class="time-text dayOfMonth"
        @click="handleTimeTextChange('dayOfMonth')">{{ $t('日') }}</span>
      <span
        class="time-text month"
        @click="handleTimeTextChange('month')">{{ $t('月') }}</span>
      <span
        class="time-text dayOfWeek"
        @click="handleTimeTextChange('dayOfWeek')">{{ $t('周') }}</span>
    </div>
    <i
    ...
    <div id="periodic-cron-tips-html">
      <img
        style="width:542px;height: 258px;"
        class="ui-img"
        :src="periodicCronImg">
      <p
        v-if="shortestTime"
        class="shortest-time-tips">
    ...
    <div
      ...
      <div
        ...
        <i class="bk-icon icon-angle-double-down arrow-button" />
      </div>
    </div>
  </div>
</template>
