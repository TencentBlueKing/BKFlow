  ...
  <div class="palette-panel">
    <div class="palette-container">
      <div
        ...
        <div :class="`node-type-icon common-icon-node-startpoint-${langSuffix}`" />
      </div>
      <div
        :class="[
          'palette-item',
        ...
        data-config-name=""
        data-type="endpoint">
        <div :class="`node-type-icon common-icon-node-endpoint-${langSuffix}`" />
      </div>
      <div
        :class="['palette-item', 'entry-item', 'palette-with-menu', { actived: menuType === 'plugin' }]"
        data-type="tasknode"
        @mousedown="onNodeMouseDown('plugin', $event)">
        <div class="node-type-icon common-icon-node-tasknode" />
      </div>
      <!--一期不做-->
      <!-- <div
      ...
      <div
        class="palette-item entry-item"
        data-config-name=""
        data-type="parallelgateway">
        <div class="node-type-icon common-icon-node-parallelgateway" />
      </div>
      <div
        class="palette-item entry-item"
        data-config-name=""
        data-type="branchgateway">
        <div class="node-type-icon common-icon-node-branchgateway" />
      </div>
      <div
        class="palette-item entry-item"
        data-config-name=""
        data-type="convergegateway">
        <div class="node-type-icon common-icon-node-convergegateway" />
      </div>
      <div
        class="palette-item entry-item"
        data-config-name=""
        data-type="conditionalparallelgateway">
        <div class="node-type-icon common-icon-node-conditionalparallelgateway" />
      </div>
    </div>
