            ...
            values.forEach((v, index) => {
              switch (index) {
                case 0:
                  ...
                  if (!this.hook) { // 表单没有被勾选
                    hasDiff = ip.some(value =>
                      ...
                      this.staticIpList.every(item => item.bk_host_id !== value.bk_host_id))
                ...
                case 1:
                  ...
                  hasDiff = topo.every(item => this.loopDynamicIpList(this.dynamicIpList, item.bk_obj_id, item.bk_inst_id))
                ...
                case 3:
                  ...
                  hasDiff = dynamicGroups.some(value => this.dynamicGroupList.every(item => item.id !== value.id))
